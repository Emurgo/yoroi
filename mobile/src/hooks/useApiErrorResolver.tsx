...
export const useApiErrorResolver = () => {
  ...
  const resolver = React.useCallback(
    (error: unknown) => {
      ...
      if (error instanceof Api.Errors.InvalidState)
        return dialogs.errorInvalidState
      ...
      if (error instanceof Api.Errors.ResponseMalformed)
        return dialogs.errorResponseMalformed
      ...
      if (error instanceof Api.Errors.TooManyRequests)
        return dialogs.errorTooManyRequests
      if (error instanceof Api.Errors.Unauthorized)
        return dialogs.errorUnauthorized
