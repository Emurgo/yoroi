...
import {supportedCurrencies} from '~/features/Settings/ui/screens/ChangeApplicationSettingsScreen/ChangeCurrencyScreen/CurrencyContext'
...
export const errorMessages = freeze(
  {
    collateral: {
    ...
    missingCollateral: defineMessages({
      title: {
        ...
        defaultMessage:
          '!!!Collateral amount is insufficient. Please assign collateral.',
      },
    }),
...
export const actionMessages = freeze(
  defineMessages({
    send: {
      id: 'global.send',
      defaultMessage: '!!!Send',
