...
export const stakingMessages = defineMessages({
  ...
  stakePools: {
    id: 'components.staking.stakePools',
  ...
  poolTicker: {
    id: 'components.staking.poolTicker',
  ...
  poolHomepage: {
    id: 'components.staking.poolHomepage',
    defaultMessage: '!!!Pool Homepage',
  },
  poolMargin: {
    id: 'components.staking.poolMargin',
    defaultMessage: '!!!Pool Margin',
  },
  poolFixedCost: {
    id: 'components.staking.poolFixedCost',
  ...
  poolROA: {
    id: 'components.staking.poolROA',
    defaultMessage: '!!!Pool ROA',
  },
  poolBlocks: {
    id: 'components.staking.poolBlocks',
  ...
  poolLifetime: {
    id: 'components.staking.poolLifetime',
    defaultMessage: '!!!Pool Lifetime',
  },
  poolLifetimeROA: {
    id: 'components.staking.poolLifetimeROA',
    defaultMessage: '!!!Pool Lifetime ROA',
  },
  poolLifetimeBlocks: {
    id: 'components.staking.poolLifetimeBlocks',
  ...
  poolLifetimeStake: {
    id: 'components.staking.poolLifetimeStake',
    defaultMessage: '!!!Pool Lifetime Stake',
  },
  poolLifetimeRewards: {
    id: 'components.staking.poolLifetimeRewards',
  ...
  poolLifetimeMargin: {
    id: 'components.staking.poolLifetimeMargin',
    defaultMessage: '!!!Pool Lifetime Margin',
  },
  poolLifetimeFixedCost: {
    id: 'components.staking.poolLifetimeFixedCost',
