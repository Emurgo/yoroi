...
export const discoverMessages = defineMessages({
  ...
  categories: {
    id: 'components.discover.categories',
    defaultMessage: '!!!Categories',
  },
  featured: {
    id: 'components.discover.featured',
    defaultMessage: '!!!Featured',
  },
  popular: {
    id: 'components.discover.popular',
    defaultMessage: '!!!Popular',
  },
  recent: {
    id: 'components.discover.recent',
  ...
  games: {
    id: 'components.discover.games',
    defaultMessage: '!!!Games',
  },
  finance: {
    id: 'components.discover.finance',
    defaultMessage: '!!!Finance',
  },
  social: {
    id: 'components.discover.social',
  ...
  education: {
    id: 'components.discover.education',
  ...
  loading: {
    id: 'components.discover.loading',
