...
describe('convertHexKeyHashToBech32Format', () => {
  ...
  it('should convert a hex key hash to a bech32 format', () => {
    expect(
      convertHexKeyHashToBech32Format(
...
describe('parseDrepId', () => {
  ...
  it('should parse a key hash in bech32 format', () => {
    const result = parseDrepId(
  ...
  it('should parse a key hash in base32 format', () => {
    const result = parseDrepId(
  ...
  it('should parse a key hash starting with 22 in hex format', () => {
    const result = parseDrepId(
  ...
  it('should parse a drep_vkh1 key hash in bech32 format', () => {
    const result = parseDrepId(
  ...
  it('should parse a script hash in bech32 format', () => {
    const result = parseDrepId(
  ...
  it('should parse a script hash starting with 23 in hex format', () => {
    const result = parseDrepId(
