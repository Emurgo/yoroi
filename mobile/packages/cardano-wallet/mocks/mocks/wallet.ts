  ...
  getCollateralInfo: () => {
    return {
      utxo: {
        ...
        tx_hash:
          '22d391c7a97559cb4784bd975214919618acce75cde573a7150a176700e76181' as TransactionHash,
        tx_index: 2,
        receiver:
...
const txid =
  '31b1abca49857fd50c7959cc019d14c7dc5deaa754ba45372fb21748c411f210' as TransactionHash
...
/**
 * Helper function to create a mock TokenEntry without individual field casts
 */
function createMockTokenEntry(data: {
  identifier: string
  amount: BigNumber
}): CardanoTypes.TokenEntry {
  return {
    identifier: data.identifier as TokenId,
    amount: data.amount,
  }
}

const rawTokenEntriesData = [
  {
    identifier:
...
const balances: Balance.Amounts = {
  ...
  ['698a6ea0ca99f315034072af31eaac6ec11fe8558d3f48e9775aab9d.7444524950' as TokenId]:
    '12344' as Balance.Quantity,
  ['29d222ce763455e3d7a09a665ce554f00ac89d2e99a1a83d267170c6.4d494e' as TokenId]:
    '215410' as Balance.Quantity,
  ['1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65f.74484f444c52' as TokenId]:
    '5' as Balance.Quantity,
  ['1ca1fc0c880d25850cb00303788dfb51bdf2f902f6dce47d1ad09d5b.44' as TokenId]:
    '2463889379' as Balance.Quantity,
  ['08d91ec4e6c743a92de97d2fde5ca0d81493555c535894a3097061f7.c8b0' as TokenId]:
    '148' as Balance.Quantity,
  ['1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c53' as TokenId]:
    '100000008' as Balance.Quantity,
  ['1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c54' as TokenId]:
    '1000000000012' as Balance.Quantity,
  ['1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c55' as TokenId]:
    '100000000000000000020' as Balance.Quantity,
}
...
const tokenInfos: Record<string, Balance.TokenInfo> = {
  ...
  '648823ffdad1610b4162f4dbc87bd47f6f9cf45d772ddef661eff198.7755534443': {
    kind: 'ft',
    id: '648823ffdad1610b4162f4dbc87bd47f6f9cf45d772ddef661eff198.7755534443' as TokenId,
    group:
      '648823ffdad1610b4162f4dbc87bd47f6f9cf45d772ddef661eff198' as PolicyId,
    ticker: 'WUSDC' as AssetName,
    image:
    ...
    name: 'wUSDC' as AssetName,
    description: 'WingRiders testnet wUSDC token.',
    fingerprint:
      'asset1n3weea8202dpev06tshdvhe9xd6f9jcqldpc2q' as TokenFingerprint,
  },
  '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c53': {
    ...
    fingerprint: toTokenFingerprint({
      policyId:
        '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e' as PolicyId,
      assetNameHex: '74484f444c53',
    }),
    description: undefined,
    ticker: '8DEC' as AssetName,
    icon: undefined,
    image: undefined,
    group: toPolicyId(
      '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c53',
  ...
  '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c54': {
    ...
    fingerprint: toTokenFingerprint({
      policyId:
        '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e' as PolicyId,
      assetNameHex: '74484f444c54',
    }),
    description: undefined,
    ticker: '12DEC' as AssetName,
    icon: undefined,
    image: undefined,
    group: toPolicyId(
      '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c54',
  ...
  '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c55': {
    ...
    fingerprint: toTokenFingerprint({
      policyId:
        '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e' as PolicyId,
      assetNameHex: '74484f444c55',
    }),
    description: undefined,
    ticker: '20DEC' as AssetName,
    icon: undefined,
    image: undefined,
    group: toPolicyId(
      '1d129dc9c03f95a863489883914f05a52e13135994a32f0cbeacc65e.74484f444c55',
...
const stakingInfo: StakingInfo = {
  status: 'staked',
  amount: '123456789' as BalanceQuantity,
  rewards: '123' as BalanceQuantity,
  poolId: 'poolId',
}
...
const unsignedTransaction: UnsignedTransaction & {mock: true} = {
  ...
  outputs: [
    {
      ...
      amounts: {[primaryTokenId]: '99999' as Balance.Quantity},
    },
  ],
  certificates: [],
  withdrawals: [],
  ...
  metadata: [],
  options: {},
  cbor: 'mock-cbor-hex' as TransactionCbor,
  mock: true,
}
...
export const nft: Balance.TokenInfo = {
  kind: 'nft',
  id: `8e2c7604711faef7c84c91b286c7327d17df825b7f0c88ec0332c0b4.${utf8ToHex('NFT 0')}` as TokenId,
  group: '8e2c7604711faef7c84c91b286c7327d17df825b7f0c88ec0332c0b4' as PolicyId,
  name: 'NFT 0' as AssetName,
  image:
  ...
  decimals: undefined,
  ticker: 'NFT_0' as AssetName,
  description: 'NFT 0 description',
  fingerprint: getTokenFingerprint({
    policyId:
      '8e2c7604711faef7c84c91b286c7327d17df825b7f0c88ec0332c0b4' as PolicyId,
