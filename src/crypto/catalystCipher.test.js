...
test('valid encryption and decryption', async () => {
  const data = '4820f7ce221e177c8eae2b2ee5c1f1581a0d88ca5c14329d8f2389e77a465' +
...
describe('invalid decryption', () => {
  ...
  // const dataBuff = Buffer.from('some data to encrypt', 'utf8')
  const data = '4820f7ce221e177c8eae2b2ee5c1f1581a0d88ca5c14329d8f2389e77a465' +
    '655c27662621bfb99cb9445bf8114cc2a630afd2dd53bc88c08c5f2aed8e9c7cb89'
  const dataBuff = Buffer.from(data, 'hex')
  const pin = '1234'
  ...
  it('should throw on invalid password', async () => {
    ...
    const promise = decryptWithPassword(
      wrongPinBuff,
      ciphertext,
    )
