...
export class ShelleyWallet extends Wallet implements WalletInterface {
  ...
  async createDelegationTx(
    ...
    signRequest: ISignRequest<CardanoTypes.TransactionBuilder>
  ...
  async createVotingRegTx(
    ...
    serverTime: Date | void,
  ): Promise<ISignRequest<CardanoTypes.TransactionBuilder>> {
  ...
  async signTxWithLedger(request: ISignRequest<CardanoTypes.TransactionBuilder>, useUSB: boolean): Promise<SignedTx> {
    ...
    let auxiliaryData: CardanoTypes.AuxiliaryData
