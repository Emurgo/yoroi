...
import {Cardano, CardanoMobile, DefaultTokenEntry, MultiToken, SendTokenList, WalletImplementationId} from '.'
...
export const formatPath = (
  ...
  if (walletConfig.TYPE === 'bip44') {
    purpose = CONFIG.NUMBERS.WALLET_TYPE_PURPOSE.BIP44
  } else if (walletConfig.TYPE === 'cip1852') {
