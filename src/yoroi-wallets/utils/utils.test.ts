...
describe('Quantities', () => {
  ...
  it('isAtomic', () => {
    ...
    expect(Quantities.isAtomic('-2', 0)).toBe(false)
    expect(Quantities.isAtomic('001', 2)).toBe(true)
    expect(Quantities.isAtomic('002', 2)).toBe(false)
    expect(Quantities.isAtomic('0000000000000000001', 18)).toBe(true)
    expect(Quantities.isAtomic('00000000000000000001', 18)).toBe(false)
  })
  it('max', () => {
