...
import {WALLET_CONFIG as HASKELL_BYRON} from '../cardano/byron/constants'
...
export const WALLET_IMPLEMENTATION_REGISTRY = {
  HASKELL_BYRON: HASKELL_BYRON.WALLET_IMPLEMENTATION_ID, // bip44
...
export type WalletImplementationId =
  | typeof HASKELL_BYRON.WALLET_IMPLEMENTATION_ID
