...
export const availableAssetsSelector: (state: State) => Dict<Token> = createSelector(
...
export const internalAddressIndexSelector: (state: State) => Object = createSelector(
  (state) => state.wallet.internalAddresses,
  (addresses) => fromPairs(addresses.map((addr, i) => [addr, i])),
)

export const externalAddressIndexSelector: (state: State) => Object = createSelector(
  (state) => state.wallet.externalAddresses,
  (addresses) => fromPairs(addresses.map((addr, i) => [addr, i])),
)
...
export const hwDeviceInfoSelector = (state: State): ?HWDeviceInfo => state.wallet.hwDeviceInfo

export const isReadOnlySelector = (state: State): boolean => state.wallet.isReadOnly

export const walletMetaSelector = (state: State): $Diff<WalletMeta, {id: string}> => ({
...
export const lastHistorySyncErrorSelector = (state: State): any => state.txHistory.lastSyncError
...
export const lastAccountStateFetchErrorSelector = (state: State): any => state.accountState.lastFetchingError
...
export const lastPoolInfoErrorSelector = (state: State): any => state.poolInfo.lastFetchingError
...
export const lastTokenInfoErrorSelector = (state: State): any => state.tokenInfo.lastFetchingError
...
export const utxosSelector = (state: State): ?Array<RawUtxo> => state.balance.utxos
...
export const customPinHashSelector = (state: State): ?string => state.appSettings.customPinHash
...
export const installationIdSelector = (state: State): ?string => state.appSettings.installationId
...
export const serverStatusSelector = (state: State): ServerStatusCache => state.serverStatus
