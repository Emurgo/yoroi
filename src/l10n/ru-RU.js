...
// Do not translate
const languages = {
  // TODO: Add back when we have the Chinese translations
...
const ios = {
  NSFaceIDUsageDescription:
      'Активация Face ID позволяет Вам быстро и безопасно \
получить доступ к своему аккаунту.',
  NSCameraUsageDescription: 'Включение камеры позволяет \
Вам сканировать QR коды.',
}
...
const l10n = {
  global: {
    ...
    ios,
    notifications: {
      offline: 'Вы не подключены к сети. Пожалуйста, \
проверьте настройки на Вашем устройстве.',
    },
  ...
  errorDialogs: {
    generalError: (message: string) => ({
      ...
      message: `Не удалось выполнить запрошенную операцию. \
Это все, что нам известно: ${message}`,
      yesButton: common.ok,
    }),
    pinMismatch: {
      title: 'Неверный PIN',
    ...
    walletKeysInvalidated: {
      ...
      message:
        'Мы обнаружили, что биометрия в Вашем телефоне изменилась. ' +
          'В результате чего упрощенное подтверждение \
транзакции было отключено ' +
        'и отправка транзакции разрешена только с мастер-паролем. ' +
          'Вы можете заново подключить упрощенное \
подтверждение транзакций в настройках ',
      yesButton: 'ОК',
    },
    networkError: {
      title: 'Ошибка сети',
    ...
    disableEasyConfirmationFirst: {
      ...
      message:
          'Пожалуйста, сначала отключите функцию упрощенного \
подтверждения транзакции во всех ' +
        'своих кошельках',
      yesButton: common.ok,
    },
    enableFingerprintsFirst: {
      title: 'Действие не удалось',
      message:
          'Вам сначала необходимо включить биометрию \
на своем устройстве, чтобы ' +
    ...
    enableSystemAuthFirst: {
      ...
      message:
          'Вы, вероятно, отключили блокировку экрана в Вашем телефоне. \
Вам необходимо ' +
          'сначала отключить упрощенное подтверждение транзакции. \
  ...
  MnemonicExplanationModal: {
    ...
    paragraph2: [
      inline([
        ...
        normal('если только Вы не собираетесь предоставить \
им доступ к Вашим средствам.'),
      ]),
    ],
  ...
  MnemonicShowScreen: {
    ...
    mnemonicNote:
      ...
      'восстановительную фразу в безопасном месте. ' +
        'Вам будет нужна эта фраза для использования и \
восстановления Вашего кошелька. ' +
  ...
  MnemonicBackupImportanceModal: {
    ...
    newDeviceRecoveryCheckbox:
        'Я понимаю, что если данное приложение \
будет перемещено на другое устройство ' +
        'или удалено, мои средства могут быть восстановлены только \
с помощью фразы восстановления, которую ' +
  ...
  MnemonicCheckScreen: {
    title: 'Восстановительная фраза',
    instructions:
        'Нажмите на каждое слово в правильном порядке для \
проверки Вашей фразы восстановления',
    mnemonicWordsInput: {
  ...
  RestoreWalletScreen: {
    title: 'Восстановить',
    instructions:
        'Чтобы восстановить Ваш кошелек, пожалуйста, \
введите восстановительную фразу, которую ' +
    ...
    report: {
      ...
      description:
        'Если раздел FAQ не решил возникший у Вас вопрос ' +
          'пожалуйста, воспользуйтесь нашей опцией \
запроса в Техническую Поддержку.',
  ...
  BiometricsLinkScreen: {
    enableFingerprintsMessage:
      'Сначала включите использование отпечатков пальцев ' +
  ...
  BiometricsAuthScreen: {
    ...
    errors: {
      ...
      SENSOR_LOCKOUT: 'Вы использовали слишком много отпечатков, \
датчик отключен',
      SENSOR_LOCKOUT_PERMANENT:
          'Вы навсегда заблокировали свой датчик отпечатков пальцев. \
Используйте запасной вариант.',
      DECRYPTION_FAILED: 'Сбой датчика отпечатков пальцев, \
используйте запасной вариант',
  ...
  EasyConfirmationScreen: {
    ...
    enable: {
      heading:
        'Эта опция позволит Вам отправлять ADA ' +
        'транзакции со своего кошелька, ' +
      ...
      warning:
        'Пожалуйста, помните свой мастер-пароль, ' +
