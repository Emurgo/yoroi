...
還元キー、保護されたベンディングキー（shielded Vending Key）、バックアップ復元ニーモニックパスフレーズ（backup recovery mnemonic passphrases）、ADAパスコードおよびその他のコードを保管する責任を負い \
ます。 ユーザーがユーザーの仮想通貨ウォレットまたはプライベートキーへのアクセスを失ったものの、\
ユーザーの仮想通貨ウォレットまたはバックアップ復元ニーモニックフレーズおよび対応する \
...
要求または債務（合理的な費用および弁護士報酬を含みます。）についても当社、その株主、\ 取締役、役員、従業員、関連会社および代理人\
（以下「被補償当事者」といいます。）を補償し、被補償当事者を免責し、\
被補償当事者を防御することに同意します。この補償には、当社または被補償当事者の過失とされるもの\ （重過失とされるものを含みます。）\
