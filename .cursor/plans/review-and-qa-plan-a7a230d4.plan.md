...
- Some TypeScript type errors remain (documented in `KNOWN_TYPE_ISSUES.md`)
- Most are non-critical and don't affect runtime
- Ledger integration has some type issues with WASM async patterns
- Transaction builder has some Balance.Amounts type compatibility issues
...
- [ ] Review `mobile/packages/tx/transaction-builder/builder.ts` for correctness
- [ ] Verify CSL integration patterns
...
- [ ] Verify all type migrations are complete
- [ ] Check for remaining type errors (run `npx tsc --noEmit`)
...
- [ ] Determine which docs to keep/move/remove
- [ ] Check for outdated information
- [ ] Verify migration status documents match reality
