...
describe('Happy paths', () => {
  describe('Creating a wallet', () => {
    it('Shelley era', async () => {
      ...
      await driver.waitUntil(async () => createNewWalletCredentialsScreen.credentialsView().isDisplayed())
  ...
  describe('Restored wallet', () => {
    ...
    it(`Intrawallet transaction, ${NORMAL_15_WORD_WALLET.name} wallet`, async () => {
      ...
      await driver.waitUntil(async () => balanceAndFeeIsCalculated())
      await sendScreen.continueButton().click()
      await driver.waitUntil(async () => sendScreen.confirmTxButton().isDisplayed())
      ...
      try {
        await driver.waitUntil(async () => waitForNewTransaction(latestTxTime, TWO_MINUTES_TIMEOUT))
      } catch (e) {
    ...
    it(`Delegation, ${NORMAL_15_WORD_WALLET.name} wallet`, async () => {
      ...
      await driver.waitUntil(async () => stakingDashboard.isDisplayed())
      ...
      await driver.waitUntil(async () => confirmDelegationScreen.isDisplayed())
      ...
      try {
        await driver.waitUntil(async () => waitForNewTransaction(latestTxTime, TWO_MINUTES_TIMEOUT + 60000))
      } catch (e) {
        throw new AssertionError('There is no new transaction')
      }
    ...
    it(`Deregistering, ${NORMAL_15_WORD_WALLET.name} wallet`, async () => {
      ...
      await driver.waitUntil(async () => withdrawWarningScreen.isDisplayed())
      ...
      await driver.waitUntil(async () => confirmWithdrawTransactionScreen.isDisplayed())
