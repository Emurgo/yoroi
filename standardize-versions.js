...
function processPackage(packagePath) {
  ...
  try {
    ...
    if (packageJson.dependencies) {
      const updatedDeps = updateDependencies(packageJson.dependencies, 'dependencies');
    ...
    if (packageJson.devDependencies) {
      const updatedDevDeps = updateDependencies(packageJson.devDependencies, 'devDependencies');
    ...
    if (packageJson.peerDependencies) {
      const updatedPeerDeps = updateDependencies(packageJson.peerDependencies, 'peerDependencies');
...
function main() {
  ...
  console.log('- All packages now use consistent versions for shared dependencies');
  ...
  console.log('- All core dependencies (immer, axios, bignumber.js, etc.) standardized');
}
