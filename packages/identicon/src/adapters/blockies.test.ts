...
describe('Blockies', () => {
  ...
  it('should generate a base64 image tiny seed', () => {
    const base64Image = blockie.asBase64({seed: '0'})
    expect(base64Image).toMatch(/^data:image\/svg\+xml;base64,/)
  })
})
