...
describe('getCryptoAddress', () => {
  ...
  it('should throw wrong blockchain if the response meta blockchain field is CARDANO', async () => {
    const domain = mockApiResponse.meta.domain
    const expectedUrl = `${unstoppableApiConfig.mainnet.getCryptoAddress}${domain}`
    const invalidApiResponse = {
      ...mockApiResponse,
  ...
  it('should throw wrong blockchain if the response meta blockchain field is ADA', async () => {
    const domain = mockApiResponse.meta.domain
    const expectedUrl = `${unstoppableApiConfig.mainnet.getCryptoAddress}${domain}`
    const invalidApiResponse = {
      ...mockApiResponse,
