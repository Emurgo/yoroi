...
describe('resolverStorageMaker', () => {
  ...
  it('notice.save', async () => {
    ...
    expect(mockedAsyncStorage.setItem).toHaveBeenCalledWith(resolverStorageNoticedKey, JSON.stringify(notice));
  });
  it('notice.read', async () => {
    ...
    expect(mockedAsyncStorage.getItem).toHaveBeenCalledWith(resolverStorageNoticedKey);
  });
  ...
  it('notice.remove', async () => {
    ...
    expect(mockedAsyncStorage.removeItem).toHaveBeenCalledWith(resolverStorageNoticedKey);
  });
  it('clear', async () => {
