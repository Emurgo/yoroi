...
export type SwapPool = {
  ...
  tokenAPriceLovelace: string // float, current price in lovelace of tokenA, i.e. 0.000000000000000000.
  tokenBPriceLovelace: string // float, current price in lovelace of tokenB, i.e. 0.000000000000000000.
