...
export type ModelsDexName = 'MINSWAP' | 'VYFI' | 'WINGRIDER' | 'SUNDAESWAP' | 'SPECTRUM' | 'MUESLISWAP'
...
export type ModelsOrderStatus = 'PENDING' | 'COMPLETED' | 'CANCELLED' | 'BATCHING' | 'EXPIRED' | 'LIMIT' | 'STOPLOSS'
 ...
 */
export class DexHunter<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  basket = {
    /**
     ...
     */
    createCreate: (body: BasketCreateBasketRequest, params: RequestParams = {}) =>
     ...
     */
    deleteDelete: (body: BasketDeleteBasketRequest, params: RequestParams = {}) =>
      this.request<string, string>({
        path: `/basket/delete`,
        method: 'DELETE',
        body: body,
     ...
     */
    estimateCreate: (body: BasketBasketEstimateRequest, params: RequestParams = {}) =>
     ...
     */
    swapCreate: (body: BasketTokenBasketSwapRequest, params: RequestParams = {}) =>
     ...
     */
    balanceDetail: (basketId: string, address: string, params: RequestParams = {}) =>
  ...
  dexHunter = {
     ...
     */
    limitCreate: (body: DexhunterLimitOrderRequest, params: RequestParams = {}) =>
  ...
  limit = {
     ...
     */
    estimateCreate: (body: DexhunterLimitOrderRequest, params: RequestParams = {}) =>
  ...
  partners = {
     ...
     */
    createCreate: (body: PartnersCreatePartnerRequest, params: RequestParams = {}) =>
     ...
     */
    chartDetail: (partner: string, period: '1d' | '7d' | '30d', params: RequestParams = {}) =>
  ...
  stoploss = {
     ...
     */
    stoplossCreate: (body: StoplossStopLossCreationRequest, params: RequestParams = {}) =>
     ...
     */
    cancelCreate: (body: StoplossCancelStopLossBody, params: RequestParams = {}) =>
  ...
  swap = {
     ...
     */
    averagePriceDetail: (tokenIn: string, tokenOut: string, params: RequestParams = {}) =>
      this.request<Record<string, number>, string>({
     ...
     */
    bulkcancelCreate: (body: DexhunterBulkCancelRequest, params: RequestParams = {}) =>
     ...
     */
    estimateCreate: (body: SwaputilsEstimationRequest, params: RequestParams = {}) =>
     ...
     */
    globalOrdersCreate: (body: ModelsGlobalOrdersRequest, params: RequestParams = {}) =>
     ...
     */
    ordersCreate: (userAddress: string, body: ModelsOrderRequest, params: RequestParams = {}) =>
     ...
     */
    ordersByPairDetail: (tokenIn: string, tokenOut: string, params: RequestParams = {}) =>
      this.request<DexhunterOrdersByPair, any>({
     ...
     */
    pairStatsDetail: (tokenIn: string, tokenOut: string, params: RequestParams = {}) =>
     ...
     */
    reverseEstimateCreate: (body: SwaputilsReverseEstimationRequest, params: RequestParams = {}) =>
      this.request<SwaputilsEstimationResponse, string>({
     ...
     */
    trendingCreate: (body: DexhunterTrendingTokensRequest, params: RequestParams = {}) =>
