...
export const restoreNormalWalletButton = () =>
 element(by.id('restoreNormalWalletButton'))
export const restore24WordWalletButton = () =>
 element(by.id('restore24WordWalletButton'))
export const restoreReadOnlyWalletButton = () =>
 element(by.id('importReadOnlyWalletButton'))
...
export const verifyWalletContinueButton = () =>
 element(by.id('verifyWalletContinueButton'))
...
export const credentialsContinueButton = () =>
