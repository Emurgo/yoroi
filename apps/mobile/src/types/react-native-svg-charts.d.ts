...
declare module 'react-native-svg-charts' {
  ...
  interface ChartProps<T> {
    ...
    // New props added in version 5.2.0
    xMin?: any
    xMax?: any
    yMin?: any
    yMax?: any
  ...
  class PieChart<T extends PieChartData> extends React.PureComponent<
    PieChartProps<T>
  > {}
  ...
  class StackedAreaChart<T> extends React.PureComponent<
  ...
  class StackedBarChart<T> extends React.PureComponent<
