...
export const LightThemeIlustration = (props: SvgProps) => {
  return (
    <Svg width={343} height={343} viewBox="0 0 343 343" fill="none" {...props}>
      <Path d="M327 216.04L156.117 313.6 16 233.034l170.214-98.101L327 216.04z" fill="#DCE0E9" />

      <Path d="M327 195.667l-170.883 98.101L16 213.202l170.214-98.101L327 195.667z" fill="#EAEDF2" />

      <Path d="M49.063 109.841l-4.903 2.315 60.907 35.032 4.922-2.306-60.926-35.041z" fill="#08C29D" />

      <Path d="M105.087 176.394v-29.247l-60.936-35.209v29.247l60.936 35.209z" fill="#16E3BA" />

      <Path
        d="M71.144 135.244c-1.333-.771-3 .192-3 1.731v.526a2 2 0 001 1.732l26.466 15.292c1.334.771 3.001-.192 3.001-1.731v-.526a2 2 0 00-1-1.732l-26.467-15.292zM68.144 147.069a2 2 0 001 1.732l26.466 15.292c1.334.771 3.001-.191 3.001-1.731v-.526c0-.714-.381-1.374-1-1.732l-26.467-15.292c-1.333-.771-3 .192-3 1.732v.525zM55.87 123.924c-4.822-2.755-8.731-.55-8.731 4.925 0 5.476 3.909 12.145 8.73 14.9 4.822 2.754 8.73.549 8.73-4.926 0-5.475-3.908-12.144-8.73-14.899z"
        fill="#fff"
      />

      <Path d="M105.029 147.142v29.255l4.909-3.277v-28.284l-4.909 2.306z" fill="#08C29D" />

      <Path d="M220 170l28 17.02L277 171l-28-17-29 16z" fill="#52FCFF" />

      <Path d="M220 170v34l28 16v-33.083L220 170z" fill="url(#paint0_linear_21228_66810)" />

      <Path d="M248 187v33l29-16v-33l-29 16z" fill="url(#paint1_linear_21228_66810)" />

      <Path d="M137 244.151l19.515 11.863 20.212-11.166L157.212 233 137 244.151z" fill="#52FCFF" />

      <Path d="M137 244.151v23.697L156.515 279v-23.058L137 244.151z" fill="url(#paint2_linear_21228_66810)" />

      <Path d="M156.515 256v23l20.212-11.152v-23L156.515 256z" fill="url(#paint3_linear_21228_66810)" />

      <Path d="M42 189.193l23.088 14.034L89 190.017 65.912 176 42 189.193z" fill="#52FCFF" />

      <Path d="M42 189.193v28.035l23.088 13.193v-27.279L42 189.193z" fill="url(#paint4_linear_21228_66810)" />

      <Path d="M65.088 203.21v27.211L89 217.228v-27.211L65.088 203.21z" fill="url(#paint5_linear_21228_66810)" />
      ...
      <Path d="M192.81 222.571l-68.916-39.379V159.5L147.5 145l15.5 35.5 15-6 14.788 23.5.022 24.571z" fill="#C4CAD7" />

      <Path d="M176.412 44.156l-4.903 2.315 60.907 35.032 4.922-2.306-60.926-35.041z" fill="#08C29D" />
      ...
      <Path d="M232.378 81.456v29.256l4.909-3.278V79.15l-4.909 2.306z" fill="#08C29D" />

      <Defs>
        <LinearGradient
          id="paint0_linear_21228_66810"
          x1={237.07}
          y1={170}
          x2={208.036}
          y2={192.842}
