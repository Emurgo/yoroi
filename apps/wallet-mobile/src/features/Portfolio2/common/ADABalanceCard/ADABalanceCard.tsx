...
export const ADABalanceCard = () => {
  ...
  if (isLoading) {
    return <ADABalanceCardSkeleton />
  }

  return (
    <LinearGradient style={styles.root} colors={colors.gradientColor}>
      <View style={styles.rowBetween}>
        <View>
          <Text style={[styles.textWhite, styles.normalText]}>Total portfolio value</Text>
        </View>
