...
export const AddTokenFromCard = () => {
  ...
  const tokenInfo = useTokenInfo({wallet, tokenId: createOrder?.amounts?.sell?.tokenId ?? '2'})
  ...
  return (
    <SwapCard
      ...
      value={inputValue}
      amount={{tokenId: createOrder?.amounts?.sell?.tokenId, quantity: initialBalanceAvailable}}
      wallet={wallet}
