...
export const useNavigateTo = () => {
  ...
  return useRef({
    ...
    changeVote: () => navigation.navigate('governance', {screen: 'staking-gov-change-vote'}),
    notSupportedVersion: () => navigation.navigate('governance', {screen: 'staking-gov-not-supported-version'}),
    noFunds: () => navigation.navigate('governance', {screen: 'staking-gov-no-funds'}),
    submittedTx: () => navigation.navigate('governance', {screen: 'staking-gov-submitted-tx'}),
    failedTx: () => navigation.navigate('governance', {screen: 'staking-gov-failed-tx'}),
  }).current
}
