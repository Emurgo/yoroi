...
export const useNavigateTo = () => {
  ...
  return React.useRef({
    create: () => navigation.navigate('add-wallet-about-recovery-phase'),
    restore: () => navigation.navigate('add-wallet-restore-form'),
    mnemonicType: () => navigation.navigate('add-wallet-choose-mnemonic-type'),
    hw: () => navigation.navigate('add-wallet-check-nano-x'),
  }).current
}
