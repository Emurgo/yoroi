...
import {portfolioManagerStorageMaker} from './storage' // Replace with the actual file path

const mountMultiStorage = originalMultiStorage as jest.MockedFunction<typeof originalMultiStorage>
jest.mock('@yoroi/wallets')

describe('portfolioManagerStorageMaker', () => {
  beforeEach(() => {
    jest.resetAllMocks()
  })
  ...
  it('should return a BalanceStorage with tokens', () => {
    ...
    // Act
    const result = portfolioManagerStorageMaker(mockStorage as unknown as App.Storage)
