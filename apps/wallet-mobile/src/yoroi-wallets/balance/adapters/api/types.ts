...
export type ApiOffChainMetadataResponse = {[tokenId: ApiTokenId]: ApiOffChainMetadataRecord}
...
export type ApiOnChainMetadataResponse = {[tokenId: ApiTokenId]: ApiOnChainMetadataRecord}
...
export type ApiTokenSupplyResponse = {[tokenId: ApiTokenId]: ApiTokenSupplyRecord}
