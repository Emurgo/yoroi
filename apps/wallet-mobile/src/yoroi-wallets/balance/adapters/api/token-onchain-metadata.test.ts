...
describe('asLatestMetadataRecord', () => {
  ...
  it('should return the original data and undefined if contains malformatted records', () => {
    ...
    testCases.forEach((name) => {
      ...
      const records: Array<unknown> = mockGetOnChainMetadatas.withMalformattedFtAndNftRecords[key]
  ...
  it('should find and parse the right current Ft and Nft', () => {
    const manyRecords =
      mockGetOnChainMetadatas.withFtsNfts['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.manyRecords']
    const record = asLatestMetadataRecord(manyRecords, {
      name: 'manyRecords',
    ...
    expect(record).toEqual({
      ...
      mintFtRecordSelected:
        manyRecords[0]['metadata']['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842']['manyRecords'],
      mintNftMetadata: manyRecords[3],
      mintNftRecordSelected:
        manyRecords[3]['metadata']['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842']['manyRecords'],
    })
  })
  ...
  it('should properly find when there are many other mint datas', () => {
    ...
    expect(record).toEqual({
      ...
      mintNftRecordSelected:
        manyRecords[1]['metadata']['775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176']['TestingTestImage12'],
    })
  })
})
...
describe('findMetadataRecord', () => {
  ...
  it('should return the record if is present v1', () => {
    ...
    expect(record).toBe(
      mockGetOnChainMetadatas.withMultipleMints[
        '775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176.54657374696e6754657374496d6167653132'
      ][1]['metadata']['775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176']['TestingTestImage12'],
    )
  })
...
describe('getOnChainMetadatas', () => {
  ...
  it('should return an empty object when tokenIds is empty', async () => {
    const getMetadata = getOnChainMetadatas('https://localhost', fetch)
  ...
  it('should send a POST request to the correct URL with transformed asset ids', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith({
      endpoint: 'https://localhost/multiAsset/metadata',
      method: 'POST',
  ...
  it('should properly parse and return the metadata', async () => {
    ...
    expect(result).toEqual({
      '1d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4844.': {
        ...
        mintNftRecordSelected:
          mockResponse['1d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4844.'][0]['metadata'][
            '1d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4844'
          ][''],
      ...
      '5449dbad479b09de066bdf7934799c8a5aa2b66cf4a11eb759aa76c6.6e66745632': {
        ...
        mintNftRecordSelected:
          mockResponse['5449dbad479b09de066bdf7934799c8a5aa2b66cf4a11eb759aa76c6.nftV2'][0]['metadata'][
      ...
      '5449dbad479b09de066bdf7934799c8a5aa2b66cf4a11eb759aa76c6.6e667457697468496d6167654172726179': {
        ...
        mintNftRecordSelected:
          mockResponse['5449dbad479b09de066bdf7934799c8a5aa2b66cf4a11eb759aa76c6.nftWithImageArray'][0]['metadata'][
            '5449dbad479b09de066bdf7934799c8a5aa2b66cf4a11eb759aa76c6'
          ]['nftWithImageArray'],
        mintFtMetadata: undefined,
        mintFtRecordSelected: undefined,
      ...
      '775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176.6e6674457874726173416e644e6f56657273696f6e': {
        mintNftMetadata:
          mockResponse['775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176.nftExtrasAndNoVersion'][0],
        mintNftRecordSelected:
          mockResponse['775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176.nftExtrasAndNoVersion'][0]['metadata'][
            '775f356c756b70ca6b8e65feec417c7da295179eee6c4bfe9ff33176'
      ...
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.6674557375616c4d65746164617461': {
        ...
        mintFtRecordSelected:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.ftUsualMetadata'][0]['metadata'][
      ...
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.6d616e795265636f726473': {
        ...
        mintNftRecordSelected:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.manyRecords'][3]['metadata'][
            '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842'
          ]['manyRecords'],
        mintFtMetadata: mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.manyRecords'][0],
        mintFtRecordSelected:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.manyRecords'][0]['metadata'][
            '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842'
          ]['manyRecords'],
      },
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.6e6674557375616c4d65746164617461': {
        ...
        mintNftRecordSelected:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.nftUsualMetadata'][0]['metadata'][
            '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842'
          ]['nftUsualMetadata'],
        mintFtMetadata: undefined,
        mintFtRecordSelected: undefined,
      ...
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.6e667457697468417574686f72416e64457874726173': {
        mintNftMetadata:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.nftWithAuthorAndExtras'][0],
        mintNftRecordSelected:
          mockResponse['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4842.nftWithAuthorAndExtras'][0][
            'metadata'
    ...
    expect(result).toEqual({
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843.3030': {
        ...
        mintNftRecordSelected:
          mockGetOnChainMetadatas.withSameNftWithRecordsV1V2[
            '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843.00'
          ][0]['metadata']['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843']['3030'],
        mintFtMetadata: undefined,
        mintFtRecordSelected: undefined,
      },
      ...
      '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843.': {
        ...
        mintNftRecordSelected:
          mockGetOnChainMetadatas.withSameNftWithRecordsV1V2[
            '9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843.'
          ][0]['metadata']['9d88eef1d822a708cad279fc7c79c3936733b236011544f8567f4843'][''],
        mintFtMetadata: undefined,
        mintFtRecordSelected: undefined,
      },
