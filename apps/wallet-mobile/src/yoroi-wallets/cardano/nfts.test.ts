...
describe('convertNft', () => {
  ...
  describe('thumbnail and image', () => {
    it('supports ipfs images', () => {
      ...
      expect(nft.metadata.thumbnail).toEqual('https://ipfs.io/ipfs/QmZ89agib39odneyezeyxp2ekXPLqm86NHCgEXZy9PJ1Gs')
      expect(nft.metadata.image).toEqual('https://ipfs.io/ipfs/QmZ89agib39odneyezeyxp2ekXPLqm86NHCgEXZy9PJ1Gs')
    })
    ...
    it('supports non-ipfs images', () => {
      ...
      expect(nft.metadata.thumbnail).toEqual('https://example.com/image.jpeg')
      expect(nft.metadata.image).toEqual('https://example.com/image.jpeg')
    })
...
const getNftWithCustomOriginalMetadata = (originalMetadata: unknown): TokenInfo<'nft'> => ({
  ...nft,
  metadata: {
    ...nft.metadata,
    originalMetadata,
