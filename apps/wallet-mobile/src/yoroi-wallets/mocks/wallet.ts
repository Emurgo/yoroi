...
export const generateManyNfts = (): Portfolio.Token[] => {
  return Array(30)
    .fill(undefined)
    .map((_, index) => ({
      ...nft,
      info: {
        ...
        name: 'NFT ' + index,
        id: index + '',
        fingerprint: getTokenFingerprint({policyId: nft.info.group, assetNameHex: utf8ToHex('NFT ' + index)}),
      },
    }))
}
...
const tokenInfos: Record<string, Portfolio.Token> = {
...
export const nft: Portfolio.Token = {
  info: {
    kind: 'nft',
