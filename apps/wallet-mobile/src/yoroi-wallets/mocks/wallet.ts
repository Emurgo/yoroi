...
const fetchTokenInfo = {
  success: {
      ...
      return {
        ...
        metadatas: {
          mintFt: {
            ...
            desc: 'WingRiders testnet wUSDC token.',
            ticker: 'WUSDC',
            version: '1',
          },
        },
    ...
    ftNoImage: async (...args): Promise<TokenInfo> => {
      action('fetchTokenInfo')(...args)
      return {
        kind: 'ft',
        description: 'WingRiders testnet wUSDC token.',
