...
storiesOf('NftPreview', module)
  ...
  .add('Showing an SVG', () => (
    <NftPreview
      nft={{...nft, metadata: {...nft.metadata, logo: 'https://www.svgrepo.com/show/501883/ice-cream.svg'}}}
      width={200}
      height={200}
    />
  ))
  ...
  .add('Showing NFT thumbnail', () => (
    <NftPreview
      nft={{...nft, metadata: {...nft.metadata, thumbnail: 'https://www.svgrepo.com/show/501883/ice-cream.svg'}}}
      showThumbnail
      width={200}
      height={200}
    />
