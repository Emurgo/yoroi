...
export const mnemonicByIndexInput = (wordIndex: number, platform: string) => platform==='android'? element(by.type(`android.widget.EditText`)).atIndex(wordIndex):  element(by.id(`mnemonicInput${wordIndex}`)) 
